...
function Home() {
  ...
  return (
    ...
    >
      <div className="max-w-screen-xl w-full flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-20">
        ...
        <div className="w-full lg:w-1/2">
          <div className="text-left">
            ...
            <div className="mt-6 flex space-x-4 text-blue-400 text-3xl">
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
          {isLangOpen && (
            <div className="flex flex-col gap-3 p-4 bg-gray-700 dark:bg-gray-800 rounded-lg shadow-lg">
              <a href="https://github.com/JuneReyOrias" className="text-gray-400 hover:text-white transition hover:scale-110" 
              title="GitHub">
                <FaGithub size={24} />
              </a>
              <a href="https://www.linkedin.com/in/june-rey-orias-b61189278/" className="text-blue-600 hover:text-white transition hover:scale-110" 
              title="LinkedIn">
                <FaLinkedin size={24} />
              </a>
              <a href="https://drive.google.com/file/d/1pVT7glrJ6kUOVBFUDFuc_LsLOS0R4nid/view?usp=sharing" className="text-green-500 hover:text-white transition hover:scale-110" 
              title="Resume" target="_blank" rel="noopener noreferrer">
                <FaFileAlt size={24} />
              </a>
            </div>
          )}
